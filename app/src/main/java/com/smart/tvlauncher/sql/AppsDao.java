package com.smart.tvlauncher.sql;
...
public class AppsDao {
    ...
    public void resetShortcut(String shortcut){
        ContentValues contentValues = new ContentValues();
        contentValues.put("shortcut","1");
        sqLiteDatabase.update(SQLiteHelper.TABLE_NAME , contentValues,"shortcut=?" ,new String []{shortcut});
    }
}
