...
import com.smart.tvlauncher.databinding.FragmentMusicBinding;
        ...
        Observable.just(F.app_type.music)
                ...
                .subscribe(new Action1<List<AppInfo>>() {
                    ...
                    public void call(final List<AppInfo> appInfos) {
                        ...
                        binding.gvMusic.setAdapter(appsCustomAdapter);
                        binding.gvMusic.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                        ...
                        binding.gvMusic.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            @Override
