...
public class FragmentGames extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        Observable.just(F.app_type.games)
                ...
                .subscribe(new Action1<List<AppInfo>>() {
                    ...
                    public void call(final List<AppInfo> appInfos) {
                        ...
                        binding.gvGames.setAdapter(appsCustomAdapter);
                        binding.gvGames.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                if(position <appInfos.size()){
                                    ...
                                    intent.putExtra("app_type" ,F.app_type.games);
                                    startActivity(intent);
                                }
                            }
                        });
                        binding.gvGames.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            @Override
